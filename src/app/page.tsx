...
function SubmitButton() {
  ...
  return (
    <Button type="submit" disabled={pending} className="w-full rounded-lg py-6 text-lg bg-white/90 text-primary-foreground hover:bg-white">
        ...
        <div className="flex flex-col">
            ...
            <form ref={formRef} action={formAction} className="mt-8 space-y-6">
              <div>
                ...
                <Input 
                  ...
                  className="mt-2 bg-input border-border text-foreground placeholder:text-muted-foreground rounded-lg p-3" 
                />
              ...
              <div>
                ...
                <Textarea 
                  ...
                  className="mt-2 min-h-[120px] bg-input border-border text-foreground placeholder:text-muted-foreground rounded-lg p-3"
                />
          ...
          {state.tips && state.tips.length > 0 && (
            <div className="mt-6 w-full max-w-md rounded-2xl bg-black/20 p-6 shadow-2xl backdrop-blur-lg">
              <h3 className="text-xl font-semibold mb-4 text-center text-foreground">Walter Sugere:</h3>
